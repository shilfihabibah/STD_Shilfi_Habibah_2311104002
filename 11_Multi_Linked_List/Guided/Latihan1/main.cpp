...
//Meembuat elemen(node) baru pada list
...
int main(){
    ...
    //Meembuat data mahasiswa
    infotype m1 = {"Ali", "01", 'L', 3.3};
    infotype m2 = {"Boby", "02", 'L', 3.71};
    ...
    address p6 = allocate(m5);
    address p7 = allocate(m6);
    address p8 = allocate(m7);
